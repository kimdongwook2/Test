...
//		int[] people = new int[6]; //arr
		...
		//각 층 관리비 + 총 관리비 배열
//		int[] cost = new int[6]; //arr2
		int[] cost = new int[FLOOR+1]; //arr2
...
//			System.out.println("*****");
		...
		System.out.println();
		System.out.println("건물에 사는 총 인원은 " + people[FLOOR] + "명 입니다.");
		System.out.println("관리비의 총 금액은 " + cost[FLOOR] + "원 입니다.");	
