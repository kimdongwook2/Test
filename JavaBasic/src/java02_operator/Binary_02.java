...
public class Binary_02 {
	public static void main(String[] args) {
		...
		//num1변수에 저장된 값 22를 불러와서 num3변수 공간에 대입(저장)한다
		
		int num3 = num1;
		
		//--------------------------------------------------------------------------
		
		// 대입연산자는 대입한 값을 연산식에 리턴한다
...
//		33; //버려짐
		...
		//왼쪽 항의 값을 오른쪽 항의 값과 덧셈한 후 왼쪽 항에 대입한다
		num2 += num1 ;
//		num2 = num2 + num1;
		...
		num2 -= 8;		// -= 산술 복합대입연산자	(이항연산자)
		num2 =- 8;		// - 부호 변환 연산자		(단항연산자)
						// = 대입 연산자 			(이항연산자)
