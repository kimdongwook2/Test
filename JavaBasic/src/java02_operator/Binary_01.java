...
//		result = 16 + 7;	// 변수num1, num2값 불러오기
//		result = 23;		// 덧셈 연산 수행
		// -> result변수에 결과값 23이 저장된다
		...
		//잘못작성한 코드 - 연산자 우선순위, 연산방향을 고려하지 않았음
...
//		System.out.println("num1 + num2 = 156");
		...
		System.out.println("num1 / num2 = " + (num1 / num2)); //2, 몫
		System.out.println("num1 % num2 = " + (num1 % num2)); //3, 나머지
		
		//**산술 연산은 반드시 피연사자들의 데이터타입이 같아야 한다
...
//		System.out.println( (double)16 / (double)5 ); //변수값 불러오기
//		System.out.println( 16.0 / (double)5.0 ); //왼쪽항 double로 형변환
//		System.out.println( 16.0 / 5.0 ); //오른쪽항 double로 형변환
//		System.out.println( 2.5 ); //double데이터들 나눗셈
		
		System.out.println("num1 / num2 = " + ((double)num1 / (double)num2));
		
		System.out.println("---------------");
		
		System.out.println( num1 / (double)num2 ); // 보편적으로 오른쪽에 강제 형변환을 한다
